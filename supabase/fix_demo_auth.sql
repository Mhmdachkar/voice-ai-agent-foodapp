...
-- 4) profiles (depend on auth.users)
...
-- Temporarily disable the handle_new_user trigger so our manual profile inserts don't conflict
...
-- Re-upsert profiles (in case CASCADE deleted them)
INSERT INTO profiles (id, role, full_name, email, phone, food_memory) VALUES
  ...
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin', 'Alex Martinez', 'admin@demo.com', '+1-555-0200', '{}'::jsonb),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'driver', 'James Wilson', 'james@demo.com', '+1-555-0301', '{}'::jsonb),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'driver', 'Lisa Park', 'lisa@demo.com', '+1-555-0302', '{}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  role = EXCLUDED.role,
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  phone = EXCLUDED.phone,
  food_memory = EXCLUDED.food_memory;

-- Re-seed driver_status
INSERT INTO driver_status (driver_id, is_online, latitude, longitude) VALUES
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', true, 39.7817, -89.6501),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', true, 39.7900, -89.6440)
ON CONFLICT (driver_id) DO UPDATE SET is_online = EXCLUDED.is_online;

-- Re-seed addresses
INSERT INTO addresses (id, user_id, label, street, city, state, zip, is_default) VALUES
  (gen_random_uuid(), '11111111-1111-1111-1111-111111111111', 'Home', '123 Oak Street', 'Springfield', 'IL', '62701', true),
  (gen_random_uuid(), '11111111-1111-1111-1111-111111111111', 'Work', '456 Tech Park Ave', 'Springfield', 'IL', '62702', false),
  (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Home', '789 Maple Drive', 'Springfield', 'IL', '62703', true),
  (gen_random_uuid(), '33333333-3333-3333-3333-333333333333', 'Home', '321 Pine Road', 'Springfield', 'IL', '62704', true);
